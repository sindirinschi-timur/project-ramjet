...
def start_game():
    ...
    # Quests
    quests = [
        {"npc": "Timur", "location": 103, "reward": 150, "dialogue": "Welcome, traveler! I am Timur. Your journey has just begun. I hope the landing wasn't all bumpy when you arrived here in Chisinau Airport. Can you do something for me? I have these top secret files I'd like to send to my colleague Tanvir. You should find him in Bangladesh. Best of luck on your journey!\n"},  # Moldova
        {"npc": "Tanvir", "location": 102, "reward": 100, "dialogue": "Greetings! I am Tanvir. Oh, you have something for me? How did you get these? If you got these from who I think you got them from, that means you can be trusted. Our world is in danger, and we need a new teammate to fix it. I know this guy Nadim, from what I remember he should be in Amsterdam. Please find him! \n"},  # Bangladesh
        {"npc": "Nadim", "location": 104, "reward": 100, "dialogue": "Hello! I am Nadim. You've made it to Amsterdam. I have expected you.. You are him, The Traveler! You're the one who will help us build the RamJet. It is a frigate never heard of before, between the common Sedentars. I heard there are fragments of its existence only in Iran. Please go find them, I depend on you. \n"},  # Amsterdam
        {"npc": "Kiavash", "location": 101, "reward": 200, "dialogue": "Salutations! I am Kiavash. Oh wow, I haven't heard that name in ages! It was supposed to be a secret project.. I can't even think of who would be so irresponsible to leak that information! Or you must be.. The Traveler? No, it can't be. Alright, only one way to find out. If I show you the remainings of the RamJet! But I need something in return. To prove your worthiness, show me you can aquire a more respectable frigate. Come back in an EtherBus, I always loved those. \n"}  # Iran
    ]
